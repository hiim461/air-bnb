  ...
  return (
    <>
      <div className="sticky-top bg-white">
        {["lg"].map((expand) => (
          <Navbar key={expand} expand={expand} className="moDau">
            <Container>
              <Navbar.Brand href="/">
                <svg style={{ width: "102", height: "32", color: "#FF385C" }}>
                  <path
                    fill="currentcolor"
                ...
                <Offcanvas.Body>
                  <Nav className="justify-content-end flex-grow-1 pe-5">
                    ...
                    >
                      ...
                      <NavDropdown.Divider />
                      <NavDropdown.Item className="item" href="#action/3.3">
